...
import { API_URL, GET_INVOICES, GET_ORDERS } from '../../Apis/FirstApi';
...
const Invoices = ({ navigation }) => {
  ...
  async function getInvoices() {
    ...
    axios.get(`${API_URL}/${GET_ORDERS}?Offset=0&Limit=0&FromDate=${value2}&ToDate=${value1}&CustomerCode=${'C08954'}`,
                    ...
                    <View style={styles.card}>
                      ...
                      <View style={{ width: SIZES.windowwidth / 2 }}>
                        <View style={styles.textrow}>
                          ...
                          <Text style={styles.text3}>{item.SONo}</Text>
                        </View>
                        <View style={styles.textrow}>
                          <View style={styles.innerrow}>
                      ...
                      <View style={{ alignSelf: 'flex-end' }}>
                        <Text style={styles.text}>{item.SODate}</Text>
                      </View>
                    </View>
